...
Author: Timo Lappalainen
  ...
  #define USE_N2K_CAN 5  // for use with STM32 boards
...
#elif defined (STM32F072xB)||defined(STM32F078xx)
#define USE_N2K_CAN USE_N2K_STM32_CAN

#else
#define USE_N2K_CAN USE_N2K_MCP_CAN //Default to external MCP controller
#endif
#endif
...
// Use STM32  internal CAN controller with t.b.d_can library
#include <NMEA2000_stm.h>       // https://github.com/xxxxxxxxxxxx
